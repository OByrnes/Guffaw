...
const ComedianThumbnail = ({comic}) =>{
  return (
    <div className="comedian__container" id={comic.id}>
      {(comic.userPhoto)?<div className="comedian_photo_holder"><img src={comic.userPhoto} alt="comedian" width="300px"/></div>:<div className="comedian_photo_holder"><img src={logourl} /></div>}
